...
$data = [];
$formName = 'Comprehensive Exam Committee';  //Important
...
if ($result['success'] && $result['data']) {
    $data = $result['data'][0];
    $formSubmitted = ($data['form_submit_flag_compre_exam_committee'] == 1);  //Important
} else {
...
$dateOfSeminar = formatDate($data['date_of_compre_exam_committee'] ?? '');  //Important
